                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-4">
                            <label for="active" class="inline-flex items-center">
                                ...
                                <input id="active" type="checkbox" name="active" value="1" {{ old('active', true) ? 'checked' : '' }} class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="payment_method" name="payment_method" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <option value="smsv" {{ old('payment_method') === 'smsv' ? 'selected' : '' }}>SMSV</option>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="cents" class="block w-full mt-1" type="number" name="cents" :value="old('cents', 0)" min="0" />
